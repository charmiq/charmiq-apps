// small two-series SVG histogram -- empirical bars in front, theoretical bars
// outlined behind
// ********************************************************************************
...
export class Histogram {
  ...
  public constructor(parent: HTMLElement, opts: HistogramOptions) {
    ...
    // .. data layers ............................................................
    // theoretical drawn first so empirical sits in front of it
  ...
  // == Drawing ===================================================================
  /** redraw both series. Both arrays must be the same length (= number of
   *  buckets). Y axis autoscales to a "nice" upper bound */
  public redraw(actual: readonly number[], theoretical: readonly number[]): void {
